...
/******/ 	__webpack_require__.p = "/Users/LeonidasEsteban/proyectos/random/platzi-video-redux/dist/";
/******/
...
var _ImmutableUtils = __webpack_require__(15);
...
var Media = function (_PureComponent) {
  ...
  function Media() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Media.__proto__ || Object.getPrototypeOf(Media)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
...
Media.propTypes = (_Media$propTypes = {
  openModal: _propTypes2.default.func.isRequired,
  cover: _propTypes2.default.string.isRequired
}, _defineProperty(_Media$propTypes, 'cover', _propTypes2.default.string.isRequired), _defineProperty(_Media$propTypes, 'title', _propTypes2.default.string.isRequired), _defineProperty(_Media$propTypes, 'author', _propTypes2.default.string.isRequired), _defineProperty(_Media$propTypes, 'type', _propTypes2.default.oneOf(['audio', 'video']).isRequired), _Media$propTypes);
...
var _errorHandle = __webpack_require__(100);
  ...
  _createClass(HandleError, [{
    ...
    value: function render() {
      if (this.state.handleError) {
        return _react2.default.createElement(_errorHandle2.default, null);
      }
...
var _normalizr = __webpack_require__(125);
...
var media = new _normalizr.schema.Entity('media', {}, {
  idAttribute: 'id',
  processStrategy: function processStrategy(value, parent, key) {
    return _extends({}, value, { category: parent.id });
  }
});

var category = new _normalizr.schema.Entity('categories', {
  playlist: new _normalizr.schema.Array(media)
});

// Entity(key, definition = {}, options = {})

var categories = { categories: new _normalizr.schema.Array(category)

  // const normalizedData = normalize(data, schema);
};var normalizedData = (0, _normalizr.normalize)(_api2.default, categories);
console.log(normalizedData);

var initialState = _extends({}, _api2.default, {
  query: '',
  searchResults: [],
  entities: normalizedData.entities
});

var store = (0, _redux.createStore)(_search2.default, initialState, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(4),n=__webpack_require__(11),p=__webpack_require__(2);
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(38),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(39),da=__webpack_require__(40),ea=__webpack_require__(41),ha=__webpack_require__(42),ia=__webpack_require__(43),C=__webpack_require__(11);
...
var _videoPlayer = __webpack_require__(65);

var _videoPlayer2 = _interopRequireDefault(_videoPlayer);

var _categories = __webpack_require__(92);

var _categories2 = _interopRequireDefault(_categories);

var _homeLayout = __webpack_require__(119);
...
var _related = __webpack_require__(121);
...
var Home = function (_Component) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      modalVisible: false
      // error: false,
    }, _this.openModal = function (video) {
      _this.setState({
        modalVisible: true,
        video: video
      });
...
var _playPause = __webpack_require__(68);
...
var _volume = __webpack_require__(79);

var _volume2 = _interopRequireDefault(_volume);

var _fullScreen = __webpack_require__(83);
...
var _videoPlayerControls = __webpack_require__(88);

var _videoPlayerControls2 = _interopRequireDefault(_videoPlayerControls);

var _videoPlayerLayout = __webpack_require__(90);
...
var _play = __webpack_require__(70);

var _play2 = _interopRequireDefault(_play);

var _pause = __webpack_require__(71);
...
function PlayPause(props) {
  return _react2.default.createElement(
    ...
    props.pause ? _react2.default.createElement(
      ...
      _react2.default.createElement(_play2.default, { size: 25 })
    ) : _react2.default.createElement(
      'button',
      {
        onClick: props.handleClick
      },
      _react2.default.createElement(_pause2.default, { size: 25 })
    )
  );
}
...
function Timer(props) {
  var currentTime = (0, _utils.formattedTime)(props.currentTime);
  var duration = (0, _utils.formattedTime)(props.duration);
  return _react2.default.createElement(
    'div',
    { className: 'Timer' },
    _react2.default.createElement(
...
var leftPad = exports.leftPad = function leftPad(number) {
  var pad = '00';
  return pad.substr(0, pad.length - number.length) + number;
};
var formattedTime = exports.formattedTime = function formattedTime(secs) {
  var secondsRounded = Math.round(secs, 10);
  var minutes = parseInt(secondsRounded / 60, 10);
  var seconds = parseInt(secondsRounded % 60, 10);
...
var _volume = __webpack_require__(80);
...
var _volume = __webpack_require__(81);
...
function VideoPlayer(props) {
  return _react2.default.createElement(
    'div',
    { className: 'VideoPlayer', ref: props.setRef },
    props.children
  );
}
...
function Categories(props) {
  return _react2.default.createElement(
    ...
    props.searchResults.length ? props.searchResults.map(function (item) {
      return _react2.default.createElement(_media2.default, item);
...
function ErrorHandle(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'Ha ocurrido un error renderizando este componente'
    )
  );
}
...
var _searchLayout = __webpack_require__(104);
...
var Search = function (_Component) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Search.__proto__ || Object.getPrototypeOf(Search)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (event) {
      event.preventDefault();
      var value = _this.inputSearch.value;
      // console.log(value);
...
function search(state, action) {
  switch (action.type) {
    case 'SET_SEARCH':
      {
        var list = state.categories[2].playlist;
...
var _Entity = __webpack_require__(126);
...
var _Array = __webpack_require__(129);
...
var _Polymorphic = __webpack_require__(37);
